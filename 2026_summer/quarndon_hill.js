...
let robot_lpf = slider(2600, 100, 2600)
let robot = note("[e6 g6 b6 e7 d7 b6 d7 a6 f#6 d6 f#6 a6 a6 c#7 e7 c#7 b6 a6 g6 bb6 d7 g7 f#7 d7]").slow(1).s("square")
  .decay(0.032)
  .sustain(0)
  .lpf(robot_lpf)
  .lpq(14)
...
$: arrange(
  ...
  // And go
  [4294967296,  stack(kick, bassline, bassline2, wobble, robot)],
)
